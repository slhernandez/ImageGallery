...
/*!
    ...
    */
;!function($){$.ender({dagron:function(options){options.target&&$(options.target).bind("drop",function(e){e.preventDefault();e.stopPropagation();options.drop&&options.drop.call(this,this)}).bind("dragenter",function(e){options.enter&&options.enter.call(this,this);e.stopPropagation();e.preventDefault()}).bind("dragover",function(e){e.stopPropagation();e.preventDefault();e.dataTransfer.dropEffect="link"}).bind("dragleave",function(e){e.stopPropagation();options.leave&&options.leave.call(this,this)});$(this).bind("dragstart",function(e){e.stopPropagation();e.dataTransfer.effectAllowed="link";e.dataTransfer.setData("Text",this.id);options.start&&options.start.call(this,this)});options.drag&&$(this).bind("drag",function(e){options.drag.call(this,this)});$(this).bind("dragend",function(e){e.stopPropagation();this.draggable=!1;options.end&&options.end.call(this,this)});this.forEach(function(el){var $handle=options.handle?$(el).find(options.handle):$(el);$handle.bind("mousedown",function(e){e.stopPropagation();el.draggable=!0})})}},1)}(ender);provide("dagron",module.exports)})();(function(){var module={exports:{}},exports=module.exports;
/*!
